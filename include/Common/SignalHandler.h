...
// 静态成员定义（放在头文件里，采用 C++17 inline 可避免多重定义，
//如果是静态成员的非 inline 定义，直接写在头文件里。如果这个头文件被两个 .cpp 包含，链接时会报 multiple definition 错误。
inline std::function<void()> SignalHandler::stopCallback_;